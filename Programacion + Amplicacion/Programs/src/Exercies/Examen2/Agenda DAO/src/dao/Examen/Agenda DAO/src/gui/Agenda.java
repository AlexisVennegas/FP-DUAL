...
public class Agenda {
	...
	private void initialize() {
		...
		botonSubir.setBounds(27, 161, 89, 23);
		frame.getContentPane().add(botonSubir);
		
		campoNombre = new JTextField();
		campoNombre.setBounds(83, 47, 86, 20);
		frame.getContentPane().add(campoNombre);
		campoNombre.setColumns(10);
		
		campoTelefono = new JTextField();
		campoTelefono.setColumns(10);
		campoTelefono.setBounds(83, 100, 86, 20);
		...
		botonBorrar.setBounds(133, 161, 89, 23);
		frame.getContentPane().add(botonBorrar);
		
		JButton botonDescargar = new JButton("Descagar");
		botonDescargar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				// sacar fila a fichero
				
				
			}
		});
		botonDescargar.setBounds(243, 161, 89, 23);
